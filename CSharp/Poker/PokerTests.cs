...
namespace Poker
{
	...
	public class DeckTests
	{
		...
		public void deckHasOnefEachCard ()
		{
			...
			Assert.AreEqual (cardsBySuit[Suit.Club].Count, 13);
			Assert.AreEqual (cardsBySuit[Suit.Diamond].Count, 13);
			Assert.AreEqual (cardsBySuit[Suit.Heart].Count, 13);
			Assert.AreEqual (cardsBySuit[Suit.Spade].Count, 13);
		}
		...
		public void testDeckKnowsItsOwnCards ()
		{
			...
			Card looseCard = new Card(Suit.Club, 2);
	...
	public class CardTests
	{
		...
		{
			Card testCard = new Card(Suit.Club, 2);
			Assert.AreEqual(Suit.Club, testCard.suit);
		}
		...
		{
			Card jack = new Card(Suit.Club, 11);
			Assert.True(jack.isFaceCard());
			Card queen = new Card(Suit.Club, 12);
			Assert.True(queen.isFaceCard());
			Card king = new Card(Suit.Club, 13);
		...
		{
			Card ten = new Card(Suit.Club, 10);
			Assert.False(ten.isFaceCard());
			Card two = new Card(Suit.Club, 2);
			Assert.False(two.isFaceCard());
			Card ace = new Card(Suit.Club, 14);
